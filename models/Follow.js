...
Follow.prototype.cleanUp = function () {
    if (typeof this.contributorId !== "string")
        this.contributorId = "";
}
...
Follow.prototype.validate = function () {
    ...
    return new Promise((resolve, reject) => {
        contributorsCollection.findOne({ _id: new ObjectID(this.contributorId) })
...
Follow.isVisitorFollowing = function (contributorId, visitorId) {
    return new Promise((resolve, reject) => {
        followsCollection.findOne({ contributorId: new ObjectID(contributorId), followerUserId: new ObjectID(visitorId) })
